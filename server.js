...
// CONFIGURACIÓN DE BASE DE DATOS (NIVEL PRODUCCIÓN)
const pool = new Pool({
...
const initDB = async () => {
    try {
        ...
        `);
        console.log("✅ Base de Datos: Tablas Listas");
        client.release();
    } catch (e) {
...
app.get('/api/admin/usuarios', async (req, res) => {
    ...
    try {
        // Traemos a todos MENOS al admin para evitar auto-eliminación
...
app.listen(port, () => console.log(`🚀 Apple Workstation Pro en puerto ${port}`));
